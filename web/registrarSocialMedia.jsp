								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- div.dataTables_borderWrap -->
                                                                                <div>
                                                                                    <br><br>
                                                                                    <form action="social_media" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                                Nombre de Social Media
                                                                                            </label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtNomsocial" value="" placeholder="Ingrese Nombre">
                                                                                            </div>
                                                                                        </div>                                                                               
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
