                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <form action="course" method="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtnomCurso" value="" placeholder="Ingrese nombre del curso">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtTheme" value="" placeholder="Ingrese tema">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtProject" value="" placeholder="Ingrese proyecto">
                                                                                            </div>
                                                                                        </div>                                                                                        
