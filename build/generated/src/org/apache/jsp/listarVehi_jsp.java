...
public final class listarVehi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<img class=\"nav-user-photo\" src=\"assets/images/avatars/photo3.png\" alt=\"Wilcas Photo\" />\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"registrarVehi.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\n");
      ...
      out.write("\t\t\t\t\t\t\t</li>             \n");
      out.write("                                                        <li class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"tipoconductor.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\n");
      out.write("\t\t\t\t\t\t\t\t\tRegistrar Tipo Conductor\n");
      out.write("\t\t\t\t\t\t\t\t</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<b class=\"arrow\"></b>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("                                                        <li class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"registraRuta.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\n");
      ...
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("                                                        <li class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"registrarContrato.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\n");
      out.write("\t\t\t\t\t\t\t\t\tRegistrar Contratos\n");
      out.write("\t\t\t\t\t\t\t\t</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<b class=\"arrow\"></b>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("                                                        <li class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"registrarConductor.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\n");
      out.write("\t\t\t\t\t\t\t\t\tRegistrar Conductor\n");
      out.write("\t\t\t\t\t\t\t\t</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<b class=\"arrow\"></b>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a  name=\"accion\" value=\"txtvUno\" href=\"#\" class=\"tooltip-error\" data-rel=\"tooltip\" title=\"Delete\">\n");
      ...
      out.write("\t\t\t\t\t\t\tSebastian Obando Perez &copy; Seobando-2019\n");
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t&nbsp; &nbsp;\n");
