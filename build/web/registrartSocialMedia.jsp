...
<%@page import="dao.socialMediaDao"%>
<%@page import="dao.teacherDao"%>
<%@page import="modelo.teacher"%>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Gestionar los Docentes de social media
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
                                                                Registrar Docentes de social media
								</small>
							</h1>
						</div><!-- /.page-header -->
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-header">
											Resultados de Docentes de social media
										</div>
										...
										<!-- div.dataTables_borderWrap -->
                                                                                <div>
                                                                                    ...
                                                                                    <form action="vehiculo" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="txtTeacher">
                                                                                                    ...
                                                                                                    <%for (teacher tech:teacherDao.listarTeacher()){%>
                                                                                                    <option value="<%= tech.getCedula()%>"><%= tech.getName() %></option>
                                                                                                    <% } %>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>                                                                                        
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                                Seleccion Social Media
                                                                                            </label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtSocialmedia" value="" placeholder="Ingrese social media">
                                                                                            </div>
                                                                                        </div> 
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtAlias" value="" placeholder="Ingrese nickname">
                                                                                            </div>
                                                                                        </div>                                                                                        
